...
/**
 * =========================
 * 🪙 COINS — SOLDE UTILISATEUR
 * =========================
 *
 * Les coins sont des unités virtuelles.
 ...
 * =========================
 *
 * Historique de tous les mouvements de coins.
 */
export const coinTransactions = pgTable("coin_transactions", {
  ...
  // purchase | gift_sent | gift_received | bonus | refund
 ...
 * =========================
 */
export const platformWithdrawals = pgTable("platform_withdrawals", {
  id: serial("id").primaryKey(),
...
export type PlatformWithdrawal =
  typeof platformWithdrawals.$inferSelect;

export type InsertPlatformWithdrawal =
  typeof platformWithdrawals.$inferInsert;
