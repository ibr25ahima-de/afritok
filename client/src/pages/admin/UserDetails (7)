                  ...
                  {video.comments?.length ? (
                    <div className="space-y-2">
                      {video.comments.map((comment: any) => (
                        <div
                          key={comment.id}
                          className="rounded-lg bg-slate-900 p-3 border border-slate-700 w-full"
                        >
                          {/* Informations du commentaire */}
                          <div className="w-full">
                            <p className="text-sm font-semibold text-purple-300 break-words">
                              {comment.userName || comment.phone || "Utilisateur"}
                            </p>

                            <p className="text-white mt-1 break-words whitespace-pre-wrap">
                              {comment.text}
                            </p>
                          ...
                          <div className="grid grid-cols-2 gap-2 mt-3 w-full">
                            ...
                            <button
                              ...
                              className="w-full bg-yellow-600 hover:bg-yellow-500 text-white px-2 py-2 rounded-lg text-xs font-semibold"
                            >
                              ⚠️ Avertir
                            </button>
                            ...
                            <button
                              ...
                              className="w-full bg-red-600 hover:bg-red-500 text-white px-2 py-2 rounded-lg text-xs font-semibold"
                            >
                              🗑️ Supprimer
                            </button>
