    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-800 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-green-400">{balance.totalEarnings.toFixed(2)} $</p>
        </div>

        <div className="bg-slate-800 rounded-lg p-4">
          <p className="text-gray-400">Retraits</p>
          <p className="text-2xl font-bold text-red-400">{balance.totalWithdrawals.toFixed(2)} $</p>
        </div>
                      ...
                      {video.comments.map((comment: any) => (
                        ...
                        >
                          <p className="text-sm font-semibold text-purple-300">
                            {comment.userName || comment.phone}
                          </p>
