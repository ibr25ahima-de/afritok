            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-3 text-sm text-gray-300">
                  <p>👁️ Regarder des vidéos → gagne de l’argent</p>
                  <p>❤️ Liker des vidéos → gagne de l’argent</p>
                  <p>🔁 Partager des vidéos → gagne de l’argent</p>
                  <p>💬 Commenter → gagne de l’argent</p>
                  <p>🎬 Publier des vidéos → gagne encore plus</p>
                </div>
              </div>
              ...
              {/* 💸 RETRAIT */}
              <div>
                <h3 className="text-white font-bold mb-3">💸 Retrait</h3>
                <p className="text-sm text-gray-300">
                  Minimum : 1000 CFA<br />
                  Paiement sous 24h
                </p>
