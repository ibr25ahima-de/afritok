  ...
  const handleWithdraw = async () => {
    try {
      await withdrawMutation.mutateAsync({
        ...
        method: "mobile_money", // simple pour l’instant
      });
        ...
        <div className="fixed inset-0 bg-black/80 z-50 flex items-end">
          <div className="w-full bg-gray-900 rounded-t-2xl p-6 max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-800 rounded-xl p-4">
                  ...
                  <ul className="text-gray-300 text-sm space-y-2">
                    <li>👁️ Regarde des vidéos → tu gagnes de l’argent</li>
                    <li>🎬 Poste des vidéos → gagne sur chaque vue</li>
                    <li>🔥 Plus tu es actif → plus tu gagnes</li>
                  </ul>
                </div>
                ...
                <div className="bg-gray-800 rounded-xl p-4">
                  ...
                  <ul className="text-gray-300 text-sm space-y-2">
                    <li>⛔ Pas de spam (actions trop rapides bloquées)</li>
                    <li>🎯 Une action = 1 récompense</li>
                    <li>📅 Limite quotidienne pour les créateurs</li>
                  </ul>
                </div>
            ...
            <div className="bg-black/50 rounded-lg p-4 mb-6">
              <p className="text-gray-400 text-sm mb-1">Total accumulé</p>
              ...
              <div className="grid grid-cols-2 gap-4 mt-4 pt-4 border-t border-gray-800">
                <div>
                  ...
                  <p className="text-xl font-bold text-green-400">${availableEarnings.toFixed(2)}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-xs mb-1">En attente</p>
                  <p className="text-xl font-bold text-yellow-400">${pendingEarnings.toFixed(2)}</p>
                </div>
              </div>
              <Button className="w-full mt-6 bg-red-500 hover:bg-red-600 text-white font-bold py-6 rounded-xl text-lg">
                Retirer mes gains
              </Button>
            </div>
            ...
            {/* PROGRESS BAR */}
            <div className="mb-8">
              <h3 className="text-lg font-semibold text-white mb-4">Progression vers le niveau suivant</h3>
              <MonetizationProgressBar currentViews={0} targetViews={1000} />
            </div>
