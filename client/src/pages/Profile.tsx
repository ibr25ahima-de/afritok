...
import { ArrowLeft, Play, Heart, MessageCircle, Share2, MapPin, Edit3, UserPlus, UserCheck, MoreVertical, Flame } from "lucide-react";
    ...
    <div className="min-h-screen bg-black text-white pb-20">
      ...
      <header className="sticky top-0 z-40 bg-black/80 backdrop-blur border-b border-gray-800 px-4 py-3 flex items-center justify-between">
        ...
        >
          ...
          {showMenu && (
            <div className="absolute right-0 top-full mt-2 bg-gray-900 rounded-lg shadow-lg z-50">
              <button className="block w-full text-left px-4 py-2 hover:bg-gray-800 text-sm">
                Signaler
              </button>
              <button className="block w-full text-left px-4 py-2 hover:bg-gray-800 text-sm border-t border-gray-700">
                Bloquer
              </button>
            </div>
          )}
