        ...
        <div className="fixed inset-0 bg-black/80 z-50 flex items-end">
          <div className="w-full bg-gray-900 rounded-t-2xl p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-black/50 rounded-lg p-4 mb-6">
              ...
              <p className="text-4xl font-bold text-white mb-2">$1,234.56</p>
              <p className="text-green-400 text-sm">↑ +12% par rapport au mois dernier</p>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-black/50 rounded-lg p-4 hover:bg-black/70 transition cursor-pointer">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-white font-bold">Vues vidéo</h3>
                    <p className="text-gray-400 text-sm">Basé sur les vues de tes vidéos</p>
                  </div>
                  <p className="text-2xl font-bold text-white">$456.78</p>
                </div>
              </div>
              ...
              <div className="bg-black/50 rounded-lg p-4 hover:bg-black/70 transition cursor-pointer">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-white font-bold">Cadeaux en direct</h3>
                    <p className="text-gray-400 text-sm">Cadeaux reçus en live</p>
                  </div>
                  <p className="text-2xl font-bold text-white">$234.56</p>
                </div>
              </div>
              ...
              <div className="bg-black/50 rounded-lg p-4 hover:bg-black/70 transition cursor-pointer">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-white font-bold">Sponsorisation</h3>
                    <p className="text-gray-400 text-sm">Contrats de marques</p>
                  </div>
                  <p className="text-2xl font-bold text-white">$343.22</p>
                </div>
              </div>
              ...
              <div className="bg-black/50 rounded-lg p-4 hover:bg-black/70 transition cursor-pointer">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-white font-bold">Fonds créateurs</h3>
                    <p className="text-gray-400 text-sm">Programme de partage des revenus</p>
                  </div>
                  <p className="text-2xl font-bold text-white">$200.00</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 bg-blue-900/30 border border-blue-500/50 rounded-lg p-4">
              <h3 className="text-white font-bold mb-3">Conditions d'éligibilité</h3>
              <ul className="text-gray-300 text-sm space-y-2">
                ...
                <li className="flex items-center gap-2">
                  <span className="text-green-400">✓</span>
                  100,000+ vues (30 derniers jours)
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-400">✓</span>
