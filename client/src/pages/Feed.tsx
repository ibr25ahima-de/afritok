              ...
              <div className="absolute right-3 top-32 flex flex-col gap-4 z-50">
                ...
                >
                  ...
                  <p className="text-xs font-semibold text-white">
                    {counters?.likes ? (counters.likes > 1000 ? `${(counters.likes / 1000).toFixed(1)}K` : counters.likes) : 0}
                  </p>
                </button>
                ...
                >
                  ...
                  <p className="text-xs font-semibold text-white">
                    {counters?.comments ? (counters.comments > 1000 ? `${(counters.comments / 1000).toFixed(1)}K` : counters.comments) : 0}
                  </p>
                </button>
                ...
                >
                  ...
                  <p className="text-xs font-semibold text-white">
                    {counters?.favorites ? (counters.favorites > 1000 ? `${(counters.favorites / 1000).toFixed(1)}K` : counters.favorites) : 0}
                  </p>
                </button>
                ...
                >
                  ...
                  <p className="text-xs font-semibold text-white">
                    {counters?.shares ? (counters.shares > 1000 ? `${(counters.shares / 1000).toFixed(1)}K` : counters.shares) : 0}
                  </p>
                </button>
              </div>
