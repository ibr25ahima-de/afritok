...
export default function UploadVideo() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Convert File to Buffer for tRPC transmission
      const arrayBuffer = await selectedFile.arrayBuffer();
      const buffer = Buffer.from(arrayBuffer);

      setUploadProgress(40);

      // Upload file to Supabase Storage via tRPC (server-side)
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <Button
                ...
                disabled={!selectedFile || !title.trim() || uploadFileMutation.isPending || uploadMutation.isPending}
                className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3"
              >
                {uploadFileMutation.isPending || uploadMutation.isPending
