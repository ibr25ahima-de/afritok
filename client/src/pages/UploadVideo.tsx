...
export default function UploadVideo() {
  ...
  // Use tRPC mutation for video upload
  ...
  /**
   * Convert File to ArrayBuffer for tRPC transmission
   */
  ...
  const handleUpload = async () => {
    ...
    try {
      // ✅ Convert File to ArrayBuffer before sending to tRPC
      const fileBuffer = await fileToArrayBuffer(selectedFile);
      ...
      await uploadMutation.mutateAsync({
        ...
        // ✅ Send file as array (will be converted back to Buffer on backend)
        file: fileArray as any,
