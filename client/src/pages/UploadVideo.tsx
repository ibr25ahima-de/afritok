...
export default function UploadVideo() {
  ...
  // Use tRPC mutation for video metadata
  ...
  const handleUpload = async () => {
    ...
    try {
      // Step 1: Upload file to backend storage endpoint
      ...
      // Step 2: Save video metadata to database via tRPC
      await uploadMutation.mutateAsync({
        title: title.trim(),
        description: description.trim(),
        videoUrl, // Send the URL, not the file
      });
