...
export const AR_EFFECTS: AREffect[] = [
  {
    ...
    description: 'Beauté naturelle', beautyConfig: {},
  },
  {
    ...
    description: 'Peau lissée naturellement', beautyConfig: { smoothSkin: 0.40, brightenSkin: 0.12, symmetry: 0.08 },
  },
  {
    id: 'beauty-smooth', name: 'Peau lisse', category: 'beauty',
    thumbnail: 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=120&h=120&fit=crop&crop=face',
    description: 'Lissage renforcé', beautyConfig: { smoothSkin: 0.90, brightenSkin: 0.18, symmetry: 0.12 },
  },
  {
    ...
    description: 'Teint très lisse', beautyConfig: { smoothSkin: 1, brightenSkin: 0.30, whitenTeeth: 0.5, symmetry: 0.20 },
  },
  {
    ...
    description: 'Éclat lumineux', beautyConfig: { smoothSkin: 0.55, brightenSkin: 0.55, enlargeEyes: 0.15 },
  },
  {
    ...
    description: 'Yeux agrandis', beautyConfig: { enlargeEyes: 0.85, smoothSkin: 0.45 },
  },
  {
    ...
    description: 'Affine le visage', beautyConfig: { slimFace: 0.80, smoothSkin: 0.45 },
  },
  {
    id: 'beauty-full-lips', name: 'Lèvres pulpeuses', category: 'beauty',
    thumbnail: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=120&h=120&fit=crop&crop=face',
    description: 'Lèvres plus volumineuses', beautyConfig: { enlargeLips: 0.75, smoothSkin: 0.45 },
  },
  {
    ...
    description: 'Symétrie douce', beautyConfig: { symmetry: 0.85, smoothSkin: 0.50 },
  },
];
...
export const EffectsPanel: React.FC<EffectsPanelProps> = ({ selectedEffect, onSelectEffect }) => {
  ...
  return (
    <div className="w-full bg-black/55 backdrop-blur-md py-1">
      <div
        ref={scrollRef}
