  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 border border-purple-800/50 rounded-lg w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        {/* Import from Device Section */}
        <div className="p-4 border-b border-purple-800/30">
          <label className="flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 rounded-lg py-3 cursor-pointer text-white font-semibold transition-colors active:scale-95">
            <Upload className="w-5 h-5" />
            Ajouter une musique depuis l'appareil
            <input
              type="file"
              accept="audio/*"
              hidden
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 mt-2 text-sm">
                      ...
                      <span className="text-purple-300">{Math.round(sound.duration)}s</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {isPlaying === sound.id ? <Pause className="w-5 h-5" /> : <Play className="w-5 h-5" />}
                    </button>
                    <Button
