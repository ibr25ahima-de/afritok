...
import { X, MessageCircle, Share2, Mail, Link as LinkIcon, Download } from "lucide-react";
...
export default function ShareModal({ videoId, videoTitle, videoUrl, onClose }: ShareModalProps) {
  ...
  const handleDownload = () => {
    ...
    link.href = videoUrl;
    link.download = "afritok-video.mp4";
    ...
    <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center">
      <div className="bg-slate-900 rounded-lg p-6 max-w-sm w-full mx-4 border border-purple-800/50">
        ...
        <div className="space-y-3">
          ...
          {/* ✅ NOUVEAU BOUTON DOWNLOAD */}
          <button
            onClick={handleDownload}
            className="w-full flex items-center gap-3 bg-gray-700 hover:bg-gray-600 text-white p-3 rounded-lg transition"
          >
