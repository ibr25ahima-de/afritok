...
function Router() { const { loading } = useAuth(); if (loading) return <div className="flex items-center justify-center min-h-screen bg-black text-white"><Loader2 className="animate-spin w-12 h-12" /></div>; return <Switch>
  <Route path="/" component={Home} /><Route path="/login" component={Login} /><Route path="/feed" component={Feed} /><Route path="/discover" component={Discover} /><Route path="/upload/:videoId?" component={Upload} /><Route path="/publish" component={Publish} /><Route path="/inbox" component={Inbox} /><Route path="/live" component={Live} /><Route path="/live/:sessionId" component={Live} /><Route path="/profile/:userId" component={Profile} /><Route path="/profile" component={Profile} /><Route path="/gifts" component={Gifts} /><Route path="/audio/:videoId" component={AudioDetail} /><Route path="/advertising" component={Advertising} /><Route path="/premium" component={AfritokPremium} /><Route path="/monetization" component={Monetization} /><Route path="/search" component={Search} /><Route path="/trending" component={Trending} /><Route path="/edit-profile" component={EditProfile} /><Route path="/my-videos" component={MyVideos} /><Route path="/notifications" component={Notifications} /><Route path="/settings" component={Settings} /><Route path="/instant-withdraw" component={InstantWithdraw} /><Route path="/afritok-studio" component={AfritokStudio} /><Route path="/balance" component={Balance} /><Route path="/wallet" component={Wallet} /><Route path="/coins" component={Coins} /><Route path="/qr-code" component={QRCode} />
  <Route path="/admin/users/:userId">{(params) => <AdminRoute component={UserDetails} {...params} />}</Route><Route path="/admin/music">{(params) => <AdminRoute component={AdminMusic} {...params} />}</Route><Route path="/admin/finance">{(params) => <AdminRoute component={PlatformFinance} {...params} />}</Route><Route path="/admin">{(params) => <AdminRoute component={AdminDashboard} {...params} />}</Route><Route path="/404" component={NotFound} /><Route component={NotFound} />
</Switch>; }
