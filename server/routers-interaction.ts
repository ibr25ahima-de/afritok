...
export const likeRouter = router({
  toggle: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const earning = await createEarning(video.userId, 0.01, "like", input.videoId);
...
export const commentRouter = router({
  ...
  create: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const earning = await createEarning(video.userId, 0.02, "comment", input.videoId);
...
export const favoriteRouter = router({
  toggle: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const earning = await createEarning(video.userId, 0.008, "favorite", input.videoId);
...
export const shareRouter = router({
  create: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const earning = await createEarning(video.userId, 0.05, "share", input.videoId);
