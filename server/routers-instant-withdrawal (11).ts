...
export const instantWithdrawalRouter = router({
  ...
  withdraw: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      // Note: Le code fourni utilise 'db', mais ici nous utilisons les fonctions importées de './db'
      // pour rester cohérent avec la structure existante du fichier.
      
      // 💾 5. Créer retrait (status = pending/completed selon la logique fournie)
      ...
      return {
        success: true,
        message: "✅ Votre retrait a été validé avec succès ! Votre solde a été mis à jour.",
      };
    }),
